...
/**
 * The Tricorn set is the result of a mathematical function, of which the complex numbers c are
 * inserted into f(z) = -z^2 + c. If the function with point c does not diverge to infinity, c belongs to the
 * set.
 */
public class TricornSet extends Fractal {

    public TricornSet(int width, int height, double zoom, int maxIteration) {
     ...
     * Tricorn set function, the calcSet method is used.
